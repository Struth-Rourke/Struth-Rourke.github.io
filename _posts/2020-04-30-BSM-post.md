...
the trade delta, underlying asset and option bid-ask spread, the model returned an R^2 of 0.7107. These metrics indicate that 
...
majority of the explained variance with an  R^2 = 0.7107. This insinuates that additional analysis should be done looking into 
