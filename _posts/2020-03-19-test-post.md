...
and make sure that all the strike and unerlying bid-ask information didn't contain information that would create errors during 
modeling. 

I was able to engineer a the BSM model inputs using the code below:
